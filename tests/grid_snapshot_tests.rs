...
async fn grid_mode_with_geojson_data() {
  let geojson_content = fs::read_to_string("/Users/udo.hoffmann/projects/mapvas/tests/resources/feature_collection.geojson")
...
async fn grid_mode_coordinate_display_comparison() {
  let geojson_content = fs::read_to_string("/Users/udo.hoffmann/projects/mapvas/tests/resources/color_formats.geojson")
    .expect("Failed to read test GeoJSON file");
...
async fn grid_mode_ui_workflow() {
  ...
  let geojson_content = fs::read_to_string("/Users/udo.hoffmann/projects/mapvas/tests/resources/styled_feature.geojson")
    .expect("Failed to read test GeoJSON file");
